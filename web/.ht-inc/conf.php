...
define("BASEURL", "https://{$_SERVER['HTTP_HOST']}/web");   // no trailing slash - all of the URL except /index.php
define("SCRIPT", "/index.php");                 // this should only be "/index.php" unless you rename index.php to something else
define("HOMEURL", "https://{$_SERVER['HTTP_HOST']}/web"); // url to go to when someone clicks HOME or Logout
